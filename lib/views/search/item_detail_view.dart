...
class ItemDetailView extends StatelessWidget {
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // Match-score badge — cosine similarity plus any configured
                  // matching signals; it is not a probability of correctness.
                  if (score > 0) ...[
                    Row(
                      children: [
                        Container(
  ...
  Widget _tagRow(List<String> tags) => Row(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Icon(Icons.label_outline_rounded, size: 18, color: _primaryBlue),
      const SizedBox(width: 10),
      Expanded(
        child: Wrap(
          spacing: 6,
